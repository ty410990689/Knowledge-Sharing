...
public class ActionSheetDialog {
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            view.setBackgroundColor(context.getResources().getColor(R.color.colorLightGray));
            // 背景图片
            if (size == 1) {
                if (showTitle) {
            ...
            textView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 128));
            // 点击事件
